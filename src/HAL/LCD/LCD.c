...
// HAL_ErrorStatus_t LCD_Init()
// {
//     HAL_ErrorStatus_t LOC_Status = HAL_NOK;
//     MCAL_ErrorStatus_t LOC_MStatus = MCAL_NOK;

//     GPIO_StrCfg_t LcdPins[LCD_TOTAL_PINS_NUM];
//     uint8_t Index;
...
//         LcdPins[Index].mode = GPIO_MODE_Output;
//         LcdPins[Index].out_type = GPIO_OUTPUT_PushPull;
//         LcdPins[Index].speed = GPIO_SPEED_Medium;
//     }
//     LcdPins[__NUM_OF_DATA_LINES].pin = LCDs_PinCfg.E_pin.pin;
//     LcdPins[__NUM_OF_DATA_LINES].port = LCDs_PinCfg.E_pin.port;
//     LcdPins[__NUM_OF_DATA_LINES].mode = GPIO_MODE_Output;
//     LcdPins[__NUM_OF_DATA_LINES].out_type = GPIO_OUTPUT_PushPull;
//     LcdPins[__NUM_OF_DATA_LINES].speed = GPIO_SPEED_Medium;

//     LcdPins[__NUM_OF_DATA_LINES + 1].pin = LCDs_PinCfg.R_S_pin.pin;
//     LcdPins[__NUM_OF_DATA_LINES + 1].port = LCDs_PinCfg.R_S_pin.port;
//     LcdPins[__NUM_OF_DATA_LINES + 1].mode = GPIO_MODE_Output;
//     LcdPins[__NUM_OF_DATA_LINES + 1].out_type = GPIO_OUTPUT_PushPull;
//     LcdPins[__NUM_OF_DATA_LINES + 1].speed = GPIO_SPEED_Medium;

//     LcdPins[__NUM_OF_DATA_LINES + 2].pin = LCDs_PinCfg.R_W_pin.pin;
//     LcdPins[__NUM_OF_DATA_LINES + 2].port = LCDs_PinCfg.R_W_pin.port;
//     LcdPins[__NUM_OF_DATA_LINES + 2].mode = GPIO_MODE_Output;
//     LcdPins[__NUM_OF_DATA_LINES + 2].out_type = GPIO_OUTPUT_PushPull;
//     LcdPins[__NUM_OF_DATA_LINES + 2].speed = GPIO_SPEED_Medium;

//     LOC_MStatus = GPIO_InitPin(LcdPins);

//     LCD_State = LCD_STATE_INIT;
//     return (LOC_Status | LOC_MStatus);
// }

// HAL_ErrorStatus_t LCD_WriteStringAsync(uint8_t *string, uint8_t length, CallBack_t CB)
// {
//     uint8_t Index;
//     HAL_ErrorStatus_t LOC_Status = HAL_NOK;
...
// HAL_ErrorStatus_t LCD_SetCursorPositionAsync(uint8_t X_pos, uint8_t Y_pos, CallBack_t CB)
// {
//     uint8_t Index;
//     HAL_ErrorStatus_t LOC_Status = HAL_NOK;
...
// HAL_ErrorStatus_t LCD_ClearScreenAsync(CallBack_t CB)
// {
//     uint8_t Index;
//     HAL_ErrorStatus_t LOC_Status = HAL_NOK;
...
// HAL_ErrorStatus_t LCD_GetStatus(uint8_t *Status)
// {
//     HAL_ErrorStatus_t LOC_Status = HAL_NOK;
