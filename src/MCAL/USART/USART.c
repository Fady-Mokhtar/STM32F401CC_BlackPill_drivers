...
// static void USART_EndRxTransfer(USART_HandleTypeDef *huart)
// {
...
// 			dmarequest = (usartxManger->Instance->USART_CR3 & USART_CR3_DMAR);
...
// 				if (dmarequest)
// 				{
// 					ATOMIC_CLEAR_BIT(usartxManger->Instance->USART_CR3, USART_CR3_DMAR);
